...
fn run_barrel_migration(migration: &Path) -> (String, String) {
    ...
    let mut toml: String = "# This file is auto generated by barrel
[package]
name = \"tmp-generator\"
...
[dependencies]"
    ...
    toml.push_str("barrel = { version = \"*\", features = [ ");
    toml.push_str(&format!("{}", feat)); // Not sure why format strings are being weird here
    toml.push_str(" ] }");
